        ...
        <main class="Site-content"> 
            <div class="fondoForm">
                <div class="container-fluid"> 
                    ...
                    <div class="">
                        <h2 class="d-inline-block align-middle"> Listado de Asistentes </h2>
                        <input hidden id="idProd" value="<?php echo $_GET['id']?>"/>
                        <button class="btn btn-outline-primary float-right" id="listAsistentes" onclick="comprobante.topdf()"> Generar PDF </button>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-md-offset-2" id="asistList">
                            
                            <table style="margin: 10px 0 20px; width: 60%" >
                                <tbody>
                                    <tr style="padding-bottom: 15px">
                                        <th style="padding-right: 25px;font-weight: 600; width: 200px"> Actividad/espectáculo: </th>
                                        <th colspan="3" id="nombreProdu" style="font-weight: 200"> </th>
                                    </tr>
                                    <tr>
                                        <th style="padding-right: 25px;font-weight: 600"> Fecha de realización: </th>
                                        <th colspan="3" id="fechaProdu" style="font-weight: 200"> </th>
                                    </tr>
                                ...
                                <table class="table table-striped table-content col-12">
                                    ...
                                    <div class="row bloque col-md-12" id="paginas2">
                                        <ul id="paginacion2" class="pagination-lg"></ul>
                                    </div>
