    ...
    ?>
        ...
        <main class="Site-content">
            <div class="fondoForm">
                ...
                <a>
                    <h3> Espectáculos </h3>
                    <input hidden id="filtre" value="espectaculo"/>
                </a>
                <hr class="colorgraph">
                ...
                <!-- Filtros -->
                    <div class="col-md-3">
                        <div class="card" hidden>
                            <div class="card-header" id="disc"> Disciplina </div>

                            <ul class="list-group list-group-flush" id="discFiltro">
                        ...
                        <div class="card"hidden>
                            <div class="card-header" id="prec" > Precio </div>

                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"> Gratis 
                                    <label class="checkbox">
                                        <input type="checkbox" /> <span class="danger"></span>
                                    </label>
                                </li>
                                <li class="list-group-item"> Hasta $200 
                                    <label class="checkbox">
                                        <input type="checkbox" /> <span class="danger"></span>
                                    </label>
                                </li>
                                <li class="list-group-item"> Hasta $500 
                                    <label class="checkbox">
                                        <input type="checkbox" /> <span class="danger"></span>
                                    </label>
                                </li>
                                <li class="list-group-item"> Más de $500 
                                    <label class="checkbox">
                                        <input type="checkbox" /> <span class="danger"></span>
                                    </label>
                                </li>
