                ...
                <form id="formA" action="" method="" autocomplete="off">
                    ...
                    <div class="form-row"> 
                        <div class="botonesForm">    
                            <button id="btnModificar"type="button" onclick="usuario.editar()" class="btn btn-success" > Editar</button>
                            <button id="btnCambiar" type="button" class="btn btn-info" onclick="usuario.editarClave()"> Cambiar contraseña</button>
                            <button id="btnEliminar" type="button" class="btn btn-danger" name="elimCuenta" onclick="usuario.confirmar()"> Eliminar cuenta</button>
                            <!-- Botones escondidos --> 
                            <button id="btnAceptar"type="button" class="btn btn-success" onclick="usuario.modificar()" hidden> Aceptar </button>
                            <button id="btnClaveNueva"type="button" class="btn btn-success" onclick="usuario.aceptarClave()" hidden> Aceptar Clave </button>
                            <button id="btnCancelar"type="button" class="btn btn-info" onclick="usuario.cancelar()" hidden> Cancelar </button>
                            <button id="btnCancelarClave"type="button" class="btn btn-info" onclick="usuario.cancelarClave()" hidden> Cancelar </button>
                        </div>                                
                    </div>
