            ...
            <form id="formAltaEsp" action="" method="POST" autocomplete="off">
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        <label for="nombreProduccion"> Nombre del espectáculo </label>
                        <input class="form-control" type="text" id="nombreProduccion" name="nombreProduccion" placeholder="Ingresa el nombre de tu espectáculo">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                       <label for="direccionProduccion"> Ubicación </label>
                       <input class="form-control" type="text" id="direccionProduccion" name="direccionProduccion" placeholder="Ingresa nombre del lugar ó CALLE y NÚMERO">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" type="number" min="0" max="2000" step="50" id="precioProduccion" name="precioProduccion" placeholder="Ingresa el valor del espectáculo">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="descripcionProduccion"> Descripción del espectáculo </label>
                        <textarea class="form-control" maxlength="280" id="descripcionProduccion" name="descripcionProduccion" placeholder="Describe tu espectáculo para que los demás sepán de que se trata. No olvides que debe tener una longitud de HASTA 280 caracteres."></textarea>
                    </div>
                </div>
