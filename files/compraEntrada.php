                                            ...
                                            <form id="msform">
                                                ...
                                                <fieldset >
                                                    <div class="form-card">
                                                        ...
                                                        <input type="text" name="holdername" placeholder="" id="name_on_card" maxlength="19" required=""/>
                                                        <div class="row">
                                                            <div class="col-9"> 
                                                                <label class="pay">Número de tarjeta*</label> 
                                                                <input type="text" name="cardno" placeholder="" id="card_number" maxlength="16" required=""/> 
                                                            </div>
                                                            <div class="col-3"> 
                                                                <label class="pay">CVC*</label> 
                                                                <input type="text" name="cvcpwd" placeholder="***" id='cvv' maxlength="3" required=""/> 
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="row col-9"> 
                                                                <div class="col-md-2">
                                                                    <select class="list-dt form-control" id="month" name="expmonth" id="expiry_month" required="">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <select class="list-dt form-control" id="year" name="expyear" id="expiry_year"required="">
                                                                ...
                                                                <div class="col-5">
                                                                    <span hidden style="color: red" id="tarjetaValidar"> </span>
                                                                </div>
                                                            </div>
                                                        </div>
